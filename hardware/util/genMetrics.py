...
# -----------------------------------------------------------------------------
# pylint: disable=anomalous-backslash-in-string, global-variable-not-assigned, use-dict-literal
# pylint: disable=use-list-literal, consider-iterating-dictionary, redefined-builtin
# pylint: disable=consider-using-with, redefined-builtin, unused-argument
import os
