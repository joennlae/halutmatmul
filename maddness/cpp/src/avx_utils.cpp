...
void sgemm_colmajor(const float *A, const float *B, int N, int D, int M,
  ...
  if (D == 1 && M <= 6) {
    switch (M) {
    case 1:
      sgemm_colmajor_narrow_padded<1, 1>(A, B, N, D, M, out);
      return;
    case 2:
      sgemm_colmajor_narrow_padded<1, 2>(A, B, N, D, M, out);
      return;
    case 3:
      sgemm_colmajor_narrow_padded<1, 3>(A, B, N, D, M, out);
      return;
    case 4:
      sgemm_colmajor_narrow_padded<1, 4>(A, B, N, D, M, out);
      return;
    case 5:
      sgemm_colmajor_narrow_padded<1, 5>(A, B, N, D, M, out);
      return;
    case 6:
      sgemm_colmajor_narrow_padded<1, 6>(A, B, N, D, M, out);
      return;
    default:
      return;
    }
  ...
  if (D <= 4 && M <= 4) {
    ...
    case 14:
      ...
      return;
    case 21:
      sgemm_colmajor_narrow_padded<2, 1>(A, B, N, D, M, out);
      return;
    case 22:
    ...
    case 24:
      ...
      return;
    case 31:
      sgemm_colmajor_narrow_padded<3, 1>(A, B, N, D, M, out);
      return;
    case 32:
    ...
    case 34:
      ...
      return;
    case 41:
      sgemm_colmajor_narrow_padded<4, 1>(A, B, N, D, M, out);
      return;
    case 42:
  ...
  if (D >= 4 && M >= 3) {
    sgemm_colmajor_narrow_padded<4, 3>(A, B, N, D_round, M_round, out, false,
                                       A_col_stride, B_col_stride,
                                       out_col_stride);
  } else if (D % 4 == 0) {
    if (M % 2 == 0) {
  ...
  //     switch(D) {
  //         case 1:
  //             sgemm_colmajor_narrow_padded<1, 3>(A, B, N, D, M_round, out,
  //             false, A_col_stride, B_col_stride, out_col_stride); if (M_)
  //             break;
  //         case 2: sgemm_colmajor_narrow_padded<2, 3>(A, B, N, D, M_round,
  //         out, false, A_col_stride, B_col_stride, out_col_stride); break;
  //         case 3: sgemm_colmajor_narrow_padded<3, 3>(A, B, N, D, M_round,
  //         out, false, A_col_stride, B_col_stride, out_col_stride); break;
  //     }
  // } else if (M < 3) { // D must be at least 5 or would have handled this
  //     // switch(M) {
  //     //     case 1: sgemm_colmajor_narrow_padded<4, 1>(A, B, N, D_round,
  //     M_round, out, false, A_col_stride, B_col_stride, out_col_stride);
  //     break;
  //     //     case 2: sgemm_colmajor_narrow_padded<4, 2>(A, B, N, D_round,
  //     M_round, out, false, A_col_stride, B_col_stride, out_col_stride);
  //     break;
  //     // }
  // } else { // D >= 4 && M >= 3
  //     // do this as many times as possible; stuff below handles trailing dims
  //     sgemm_colmajor_narrow_padded<4, 3>(A, B, N, D_round, M_round, out,
  //     false, A_col_stride, B_col_stride, out_col_stride);
  // }
  ...
  case 10:            // one trailing input dim
    if (M % 2 == 0) { // implies m % 6 == 0, since m % 3 == 0
      sgemm_colmajor_narrow_padded<1, 6>(A_coltail, B_rowtail, N, 1, M_round,
                                         out, pos_round_mat, A_col_stride,
                                         B_col_stride, out_col_stride);
    } else {
      sgemm_colmajor_narrow_padded<1, 3>(A_coltail, B_rowtail, N, 1, M_round,
                                         out, pos_round_mat, A_col_stride,
                                         B_col_stride, out_col_stride);
    }
    // sgemm_colmajor_narrow_padded<1, 3>(
    //         A_coltail, B_rowtail, N, 1, M_round, out, pos_round_mat,
    //         A_col_stride, B_col_stride, out_col_stride);
    return;
  case 20: // two trailing input dims
    sgemm_colmajor_narrow_padded<2, 3>(A_coltail, B_rowtail, N, D_tail, M_round,
                                       out, pos_round_mat, A_col_stride,
                                       B_col_stride, out_col_stride);
    return;
  case 30: // three trailing input dims
    sgemm_colmajor_narrow_padded<3, 3>(A_coltail, B_rowtail, N, D_tail, M_round,
                                       out, pos_round_mat, A_col_stride,
                                       B_col_stride, out_col_stride);
    return;
  case 1: // one trailing output dim
    sgemm_colmajor_narrow_padded<4, 1>(A, B_coltail, N, D_round, M_tail,
                                       out_coltail, false, A_col_stride,
                                       B_col_stride, out_col_stride);
    return;
  case 2: // two trailing output dims
    sgemm_colmajor_narrow_padded<4, 2>(A, B_coltail, N, D_round, M_tail,
                                       out_coltail, false, A_col_stride,
                                       B_col_stride, out_col_stride);
    return;
  ...
  case 11: // one trailing input and one trailing output dim
    ...
    sgemm_colmajor_narrow_padded<1, 3>(A_coltail, B_rowtail, N, D_tail, M_round,
                                       out, pos_round_mat, A_col_stride,
                                       B_col_stride, out_col_stride);
    ...
    sgemm_colmajor_narrow_padded<4, 1>(A, B_coltail, N, D_round, M_tail,
                                       out_coltail, false, A_col_stride,
                                       B_col_stride, out_col_stride);
    sgemm_colmajor_narrow_padded<1, 1>(A_coltail, B_tailtail, N, D_tail, M_tail,
                                       out_coltail, pos_D_round, A_col_stride,
                                       B_col_stride, out_col_stride);
    return;
  case 12: // trailing inputs, outputs: 1, 2
    ...
    sgemm_colmajor_narrow_padded<4, 2>(A, B_coltail, N, D_round, M_tail,
                                       out_coltail, false, A_col_stride,
                                       B_col_stride, out_col_stride);
    sgemm_colmajor_narrow_padded<1, 2>(A_coltail, B_tailtail, N, D_tail, M_tail,
                                       out_coltail, pos_D_round, A_col_stride,
                                       B_col_stride, out_col_stride);
    return;
  case 21: // trailing inputs, outputs: 2, 1
    ...
    sgemm_colmajor_narrow_padded<4, 1>(A, B_coltail, N, D_round, M_tail,
                                       out_coltail, false, A_col_stride,
                                       B_col_stride, out_col_stride);
    sgemm_colmajor_narrow_padded<2, 1>(A_coltail, B_tailtail, N, D_tail, M_tail,
                                       out_coltail, pos_D_round, A_col_stride,
                                       B_col_stride, out_col_stride);
    return;
  case 22: // trailing inputs, outputs: 2, 2
    ...
    sgemm_colmajor_narrow_padded<4, 2>(A, B_coltail, N, D_round, M_tail,
                                       out_coltail, false, A_col_stride,
                                       B_col_stride, out_col_stride);
    sgemm_colmajor_narrow_padded<2, 2>(A_coltail, B_tailtail, N, D_tail, M_tail,
                                       out_coltail, pos_D_round, A_col_stride,
                                       B_col_stride, out_col_stride);
    return;
  case 31: // trailing inputs, outputs: 3, 1
    ...
    sgemm_colmajor_narrow_padded<4, 1>(A, B_coltail, N, D_round, M_tail,
                                       out_coltail, false, A_col_stride,
                                       B_col_stride, out_col_stride);
    sgemm_colmajor_narrow_padded<3, 1>(A_coltail, B_tailtail, N, D_tail, M_tail,
                                       out_coltail, pos_D_round, A_col_stride,
                                       B_col_stride, out_col_stride);
    return;
  case 32: // trailing inputs, outputs: 3, 2
    ...
    sgemm_colmajor_narrow_padded<4, 2>(A, B_coltail, N, D_round, M_tail,
                                       out_coltail, false, A_col_stride,
                                       B_col_stride, out_col_stride);
    sgemm_colmajor_narrow_padded<3, 2>(A_coltail, B_tailtail, N, D_tail, M_tail,
                                       out_coltail, pos_D_round, A_col_stride,
                                       B_col_stride, out_col_stride);
    return;
  default:
