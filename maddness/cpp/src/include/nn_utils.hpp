...
inline dist_t
maybe_insert_neighbors(Container<Neighbor> &neighbors_bsf,
...
inline vector<Neighbor> neighbors_in_radius(const T *dists, size_t len,
                                            R radius_sq) {
...
// {
//     return map([](const vector<Neighbor>& inner_neighbors) ->
//     std::vector<idx_t> {
