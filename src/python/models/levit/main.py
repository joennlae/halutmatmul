...
from models.levit.losses import DistillationLoss
from models.levit.samplers import RASampler
...
def main(args):
    models.levit.utils.init_distributed_mode(args)
    ...
    seed = args.seed + models.levit.utils.get_rank()
    ...
    if True:  # args.distributed:
        num_tasks = models.levit.utils.get_world_size()
        global_rank = models.levit.utils.get_rank()
    ...
    linear_scaled_lr = (
        args.lr * args.batch_size * models.levit.utils.get_world_size() / 512.0
    )
    ...
    if args.resume:
        ...
        if (
            ...
            if args.model_ema:
                models.levit.utils._load_checkpoint_for_ema(
    ...
    if args.eval:
        ...
        print(
            f"Accuracy of the network on the {len(dataset_val)} test "
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            for checkpoint_path in checkpoint_paths:
                models.levit.utils.save_on_master(
                    {
        ...
        if args.output_dir and models.levit.utils.is_main_process():
